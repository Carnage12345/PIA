...
class Level:
    ...
    # Draw game over screen
		...
		pygame.draw.rect(self.display_surface, (255, 255, 255), restart_button)
		pygame.draw.rect(self.display_surface, (255, 255, 255), quit_button)
		self.display_surface.blit(game_over_text, (250, 200))

		restart_font = pygame.font.SysFont(None, 36)
		restart_text = restart_font.render("Restart", True, (0, 0, 0))
		self.display_surface.blit(restart_text, (270, 310))

		quit_text = restart_font.render("Quit", True, (0, 0, 0))
		self.display_surface.blit(quit_text, (290, 410))
